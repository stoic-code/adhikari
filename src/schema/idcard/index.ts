...
export const idCardSchema = z.object({
  ...
  fullName: z.string().min(1, { message: "पुरा नाम लेख्न अनिवार्य छ" }),
  dob: z.string({ required_error: "जन्म मिति लेख्न अनिवार्य छ।" }),
  ...
  birthPlace: z.string().min(1, { message: "जन्म थालो अनिवार्य छ।" }),
  ...
  bloodGroup: z.string().min(1, { message: "रक्त समूह अनिवार्य छ।" }),
  profession: z.string().optional(),
  designation: z.string().min(1, { message: "पद को जानकारी अनिवार्य छ।" }),
  gender: z
    .string()
